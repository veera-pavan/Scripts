$dynamicPart = Get-ChildItem "C:\filepath" | Where-Object { $_.Name -like "filename*.csv" } | Sort-Object LastWriteTime -Descending | Select-Object -First 1
if ($dynamicPart) {
...
Write-Host "Error: Value 'version2.0' not found in the .csv file."
}
} else {
Write-Host "Error: No matching .csv files found."
}